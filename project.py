...
musk_image = face_recognition.load_image_file("S:\project/musk.jpg")
musk_encoding = face_recognition.face_encodings(musk_image)[0]
 
tata_image = face_recognition.load_image_file("S:\project/tata.jpg")
tata_encoding = face_recognition.face_encodings(tata_image)[0]
 
jobs_image = face_recognition.load_image_file("S:\project/jobs.webp")
